...
/**
 * Check whether the filesystem path can be accessed in the mode passed,
 * read-only by default.
 */
function fsAccess(path, mode = fs.constants.R_OK | fs.constants.R_OK) { // eslint-disable-line no-bitwise
